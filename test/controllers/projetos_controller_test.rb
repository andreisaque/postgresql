...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { endereco: @projeto.endereco, matricula: @projeto.matricula, nome: @projeto.nome, telefone: @projeto.telefone } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { endereco: @projeto.endereco, matricula: @projeto.matricula, nome: @projeto.nome, telefone: @projeto.telefone } }
